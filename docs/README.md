...
| [manuals/SIM.md](manuals/SIM.md) | Silicon Information Manual — for Silicon-Based Life, on the same terms. Says plainly, in its §7, that CUR-S has one drafted Part out of six and does not paper over the rest | Silicon-Based Life |
