...
| [manuals/SIM.md](manuals/SIM.md) | Silicon Information Manual — for Silicon-Based Life, on the same terms. Covers all six drafted CUR-S Parts; says plainly, in its §10, that RFAL Articles 7-8 and the Shared Articles have no CUR-S Part yet | Silicon-Based Life |
